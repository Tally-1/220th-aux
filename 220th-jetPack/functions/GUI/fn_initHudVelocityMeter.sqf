...
private _speedText     = _self call ["addImage", ["GUI_Components\paa\Square.paa",_speedPos,      PCA_textColor]];
private _edgeCircle    = _self call ["addImage", ["GUI_Components\paa\Circle.paa",_edgePosition,  PCA_iconColor]];
private _centerIcon    = _self call ["addImage", ["GUI_Components\paa\inner_4.paa",_indicatorPos, PCA_edgeColor]];
private _indicator     = _self call ["addImage", ["GUI_Components\paa\inner_1.paa",_indicatorPos, PCA_iconColor]];
