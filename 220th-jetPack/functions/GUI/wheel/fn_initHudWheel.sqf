...
private _circle     = _self call ["addImage", ["\220th-jetPack\GUI_Components\paa\Circle_22.paa",  _outerPos, PCA_edgeColor]];
private _midWheel   = _self call ["addImage", ["\220th-jetPack\GUI_Components\paa\outer_2.paa",   _middlePos, PCA_iconColor]];
private _innerWheel = _self call ["addImage", ["\220th-jetPack\GUI_Components\paa\inner_3.paa",    _innerPos, PCA_edgeColor]];
private _centerIcon = _self call ["addImage", ["\220th-jetPack\GUI_Components\paa\CircleFill.paa", _iconPos, PCA_textColor]];
private _dataArr    = [
	["edge",           _circle],
	["midWheel",     _midWheel],
	...
	["hide",                 RJET_fnc_hideHudWheel],
	["show",                 RJET_fnc_showHudWheel],
